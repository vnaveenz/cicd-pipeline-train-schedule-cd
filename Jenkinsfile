                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                     sshTransfer(
                                        ...
                                        removePrefix: 'dist/',
                                        remoteDirectory: '/tmp',
                                        execCommand: 'sudo /bin/systemctl stop train-schedule && sudo rm -rf /opt/train-schedule/* && unzip /tmp/trainSchedule.zip -d /opt/train-schedule && sudo /bin/systemctl start train-schedule'
                                    )
                            ]
                            )
